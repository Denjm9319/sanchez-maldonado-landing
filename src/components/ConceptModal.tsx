  ...
  return (
    ...
    >
      <div
        ...
        className="bg-cream text-body rounded-[20px] max-w-[560px] w-full p-[clamp(28px,4vw,44px)] relative shadow-[0_30px_80px_rgba(0,0,0,0.45)] max-h-[85vh] overflow-y-auto"
      >
        <button
          type="button"
          aria-label="Cerrar"
        ...
        <dl className="grid gap-[18px] text-[14.5px]">
          <div>
            <dt className="text-[11px] tracking-[0.15em] uppercase text-secondary mb-1">Rubro</dt>
            <dd>{rubro}</dd>
          </div>
          <div>
            <dt className="text-[11px] tracking-[0.15em] uppercase text-secondary mb-1">Objetivo</dt>
            <dd>{objetivo}</dd>
          </div>
          <div>
            <dt className="text-[11px] tracking-[0.15em] uppercase text-secondary mb-1">Descripción</dt>
            <dd className="leading-[1.65]">{description}</dd>
          </div>
          <div>
            <dt className="text-[11px] tracking-[0.15em] uppercase text-secondary mb-2">
              Capacidades usadas
            </dt>
            <dd className="flex flex-wrap gap-2">
              {capabilities.map((c) => (
                <span
                  key={c}
                  className="bg-navy/[0.06] border border-navy/10 rounded-full px-3 py-1.5 text-[13px]"
                >
                  {c}
                </span>
              ))}
